  ...
  return (
    <div>
      ...
      <div className={styles["content-creation-container"]}>
        ...
        <div className={styles["strategy-container"]}>
          ...
          <section className={styles["hero-grid"]}>
            <div className={styles["hero-text"]}>
              ...
              <p>
                At <strong>LCS</strong>, we empower businesses to make smarter
                decisions through comprehensive <strong>Market Research</strong>, 
                precise <strong>Competitor Analysis</strong>, and actionable 
                <strong> Strategy Making</strong>. Stay ahead in your industry 
                with insights that drive measurable success.
              </p>
              <button
          ...
          <section className={styles["carousel-section"] + " py-5"}>
            ...
            <p className="text-center mb-5 text-muted">
              Every successful business decision starts with insight and ends
            ...
            <Carousel indicators={false} interval={6000} pause="hover">
              <Carousel.Item>
                ...
                >
                  ...
                  <p>
                    We analyze industry trends, customer behavior, and emerging
                    opportunities to guide informed decision-making.
                  </p>
                </div>
              </Carousel.Item>
              <Carousel.Item>
                ...
                >
                  ...
                  <p>
                    We study your competitors’ strengths and weaknesses to craft
                    strategies that outperform and differentiate your brand.
                  </p>
                </div>
              </Carousel.Item>
              <Carousel.Item>
                ...
                >
                  ...
                  <p>
                    We create actionable, data-backed strategies aligned with
                    your business goals to maximize growth and ROI.
                  </p>
                </div>
              </Carousel.Item>
            </Carousel>
            ...
            <div className="container">
              <div className="text-center mb-4">
                ...
                <p
                  ...
                  style={{ color: '#666666' }}
                >
                  A combination of research, analysis, and creative planning for
                  sustainable success.
                </p>
              </div>
              <div className="row">
          ...
          <section className={styles["cta-section"]}>
            ...
            <p>
              Partner with us to turn insights into action and strategies into
              measurable growth.
            </p>
            <button
              className={styles["cta-button"]}
        ...
        </div> {/* closes strategy-container */}
      </div> {/* closes content-creation-container */}
