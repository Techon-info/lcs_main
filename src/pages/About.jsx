    ...
    <>
      ...
      <div className={`container py-5 ${styles.about}`}>
        <section className="mb-5">
          <h2 className={`text-center mb-3 ${styles.aboutHeading}`}>
            Lazeno Consultancy Services
          </h2>
          <p
            className="text-center mx-auto"
            style={{ maxWidth: "750px", color: "#555" }}
          >
            We are your growth partners in the digital world. At Lazeno, we
            combine creativity, strategy, and technology to deliver solutions
            that build your brand, drive traffic, and convert leads.
          </p>
        </section>
        ...
        <div className="row text-center mb-5">
          <div className="col-md-6 mb-4">
            <div className={`p-4 shadow-sm ${styles.infoBox}`}>
              ...
              <p>
                To set new benchmarks in digital marketing by delivering
                measurable value and creative excellence.
              </p>
            </div>
          </div>
          <div className="col-md-6 mb-4">
            <div className={`p-4 shadow-sm ${styles.infoBox}`}>
              ...
              <p>
                Delivering smart, data-driven digital marketing strategies to
                help brands connect, grow, and lead.
              </p>
            </div>
          </div>
        </div>
            ...
            {[FaHandshake, FaStar, FaRocket, FaCogs].map((Icon, i) => (
              <div key={i} className="col-sm-6 col-lg-3 mb-4">
                ...
                <p className={styles.cardText}>
                  {
                    [
                      "Your goals are at the core of every solution we craft.",
                      "We blend design with storytelling for lasting impressions.",
                      "Focused on metrics that matter and ROI that grows.",
                      "From content to consulting, everything under one roof.",
                    ][i]
                  }
                </p>
              </div>
